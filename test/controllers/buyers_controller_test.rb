...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post buyers_url, params: { buyer: { buyeremail: @buyer.buyeremail, buyername: @buyer.buyername } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { buyeremail: @buyer.buyeremail, buyername: @buyer.buyername } }
